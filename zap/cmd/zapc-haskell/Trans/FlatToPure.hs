...
nodeToReExports Flat.Node {name = Name.ZapQ {local}, union_ = Flat.Enum _} = [local]
nodeToReExports _ = []
          ...
          Pure.Sum
            [ Pure.Variant
              ...
              | Flat.Variant
                  { field =
                      field@Flat.Field
                        { fieldName = Name.ZapQ {local = variantName},
                          fieldLocType
                        }
                  } <-
                  variants
...
nodeToDecls ifaceMap Flat.Node {name = name@Name.ZapQ {local}, nodeId, union_, typeParams} =
