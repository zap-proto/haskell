...
data File = File
  { fileId :: !Word64,
    ...
    -- cyclic dependency with rpc.zap.
    usesRpc :: !Bool
  }
...
data Data = Data
  { typeName :: Name.LocalQ,
    ...
    -- zap sense, rather than an auxiliary type defined for a group
...
data Interface = IFace
  { name :: Name.ZapQ,
    typeParams :: [C.TypeParamRef Name.ZapQ],
    interfaceId :: !Word64,
    methods :: [Method],
...
data Field = Field
  { -- | The name of the field.
    ...
    type_ :: C.Type Brand Name.ZapQ
  }

data Variant = Variant
  { name :: Name.LocalQ,
    arg :: Maybe (C.Type Brand Name.ZapQ)
  }
