...
module Zap.Repr.Parsed (Parsed) where

import qualified Zap.Basics as B
import qualified Zap.Classes as C
import Zap.Repr (List, PtrRepr (..), Repr (..), ReprFor)
import Zap.Rpc.Common (Client)
import qualified Data.ByteString as BS
import Data.Kind (Type)
import qualified Data.Text as T

-- | @'Parsed' a@ is the high-level/ADT representation of the zap
