...
-- |
-- Module: Zap.Convert
-- Description: Convert between messages, typed zap values, and (lazy)bytestring(builders).
--
-- This module provides various helper functions to convert between messages, types defined
-- in zap schema (called "values" in the rest of this module's documentation),
...
import Zap.Classes (Parse (encode, parse))
import qualified Zap.Message as M
import Zap.Mutability (Mutability (..), freeze)
