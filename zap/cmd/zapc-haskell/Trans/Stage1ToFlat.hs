...
interfaceToNodes :: NodeMap -> Word64 -> Word64 -> Name.ZapQ -> Name.NS -> Stage1.Interface -> [C.TypeParamRef Flat.Node] -> [Flat.Node]
...
structToNodes :: NodeMap -> Word64 -> Word64 -> Name.ZapQ -> Name.NS -> Stage1.Struct -> [C.TypeParamRef Flat.Node] -> [Flat.Node]
structToNodes
  nodeMap
  thisMod
  nodeId
