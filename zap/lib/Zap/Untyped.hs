...
-- |
-- Module: Zap.Untyped
-- Description: Utilities for reading zap messages with no schema.
--
...
-- mutability of the message it contains (see "Zap.Message").
module Zap.Untyped
...
import Zap.TraversalLimit (LimitT, MonadLimit (invoice))
...
-- the Raw type in "Zap.Repr", which hides all of this...
...
-- | Allocate a list of zap @Void@ values.
