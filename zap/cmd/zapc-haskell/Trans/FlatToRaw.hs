...
nodeToDecls Flat.Node {name = Name.ZapQ {fileId, local}, union_, typeParams} =
                   ...
                   in [ Raw.UnionVariant
                        ...
                        ++ [ Raw.Setter
                             ...
                             | Flat.Variant
                                 { field =
                                     Flat.Field
                                       { fieldName = Name.ZapQ {local = fieldName},
                                         fieldLocType
                                       },
                                   tagValue
                                 } <-
...
fieldToDecls
  containerType
  typeParams
  Flat.Field {fieldName = Name.ZapQ {local = fieldName}, fieldLocType} =
    [ Raw.Getter
        { fieldName,
          typeParams,
          containerType,
