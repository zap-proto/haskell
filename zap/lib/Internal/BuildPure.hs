...
-- Description: Helpers for building zap messages in pure code.
--
-- This module provides some helpers for building zap messages and values
...
import Zap.Mutability
import Zap.TraversalLimit (LimitT, MonadLimit, evalLimitT)
...
-- | @'createPure' limit m@ creates a zap value in pure code according
