...
type Brand = Common.ListBrand Name.ZapQ
...
data Decl
  ...
  | Getter -- get_* function
      { fieldName :: Name.LocalQ,
        ...
        typeParams :: [Name.UnQ],
        fieldLocType :: Common.FieldLocType Brand Name.ZapQ
      }
  ...
  | Constant
      { name :: Name.LocalQ,
        value :: Common.Value Brand Name.ZapQ
      }
  deriving (Show, Eq)
...
data Variant = Variant
  { name :: Name.LocalQ,
    tagValue :: !Word16,
    locType :: Common.FieldLocType Brand Name.ZapQ
  }
  deriving (Show, Eq)
