...
-- | Zap message canonicalization, per:
--
-- https://zap-proto.io/docs/encoding#canonicalization
...
--
-- This code relies on the fact that Zap.Pointer.serializePointer does the
...
import Zap.Mutability (Mutability (..), unsafeThaw)
import Zap.TraversalLimit (LimitT)
